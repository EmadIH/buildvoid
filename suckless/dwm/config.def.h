#include "/home/eih/.config/suckless/dwm/themes/blue.h"
...
static const char *fonts[]          = { "monospace:size=14", "NotoNaskhArabic:size=14", "NotoColorEmoji:pixelsize=14:antialias=true:autohint=true" };
